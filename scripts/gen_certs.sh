...
pki --req --type priv --in private/siteAKey.pem \
          --dn "C=FI, O=CSE4300, CN=CSE4300 Site A 172.16.16.16" \
          --san 172.16.16.16 --outform pem > reqs/siteAReq.pem
...
pki --req --type priv --in private/siteBKey.pem \
          --dn "C=FI, O=CSE4300, CN=CSE4300 Site B 172.18.18.18" \
          --san 172.18.18.18 --outform pem > reqs/siteBReq.pem
pki --issue --cacert cacerts/intCaCert.pem --cakey intCaKey.pem \
...
pki --req --type priv --in private/cloudKey.pem \
          --dn "C=FI, O=CSE4300, CN=CSE4300 Cloud 172.30.30.30" \
          --san 172.30.30.30 --outform pem > reqs/cloudReq.pem
pki --issue --cacert cacerts/intCaCert.pem --cakey intCaKey.pem \
